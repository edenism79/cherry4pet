...
export function FinalCTASection() {
  ...
  return (
    <>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-primary/90 to-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container-responsive relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 korean-text px-4">
              작은 참여가 한 생명을 지킵니다
            </h2>

            <p className="text-lg sm:text-xl md:text-2xl mb-12 text-primary-foreground/90 korean-text px-4">
              CHERRY for PET과 함께
              <br />
              투명한 반려동물 기부를 시작하세요
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-white text-cherry-red hover:bg-white/90 text-base sm:text-lg px-6 sm:px-8 py-5 sm:py-6 h-auto font-semibold touch-target"
            ...
            <div className="mt-10 sm:mt-12 md:mt-16 grid gap-4 sm:gap-6 md:gap-8 grid-cols-1 sm:grid-cols-3 text-left">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 sm:p-6">
                ...
                <div className="text-xs sm:text-sm text-primary-foreground/80 korean-text">
                  투명한 기부금 관리
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 sm:p-6">
                <div className="text-3xl sm:text-4xl font-bold mb-2">검증된</div>
                <div className="text-xs sm:text-sm text-primary-foreground/80 korean-text">
                  파트너 및 캠페인
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-5 sm:p-6">
                <div className="text-3xl sm:text-4xl font-bold mb-2">실시간</div>
                <div className="text-xs sm:text-sm text-primary-foreground/80 korean-text">
                  진행 상황 공개
                </div>
              </div>
