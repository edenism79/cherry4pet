          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" onClick={(e) => handleLinkClick(e, '/campaigns')} className="hover:text-cherry-red transition-colors cursor-pointer">캠페인</a></li>
                <li><a href="#" onClick={(e) => handleLinkClick(e, '/partners')} className="hover:text-cherry-red transition-colors cursor-pointer">파트너</a></li>
                <li><a href="#" onClick={(e) => handleLinkClick(e, '/stories')} className="hover:text-cherry-red transition-colors cursor-pointer">소식</a></li>
                <li><a href="#" onClick={(e) => handleLinkClick(e, '/contact')} className="hover:text-cherry-red transition-colors cursor-pointer">문의하기</a></li>
              </ul>
            </div>
            <div>
