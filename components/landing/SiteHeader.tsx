          ...
          <div className="hidden md:flex items-center space-x-8">
            {navigation.map((item) => (
              <a
                ...
                className="text-gray-700 hover:text-cherry-red font-medium transition-colors cursor-pointer"
              >
                {item.name}
              </a>
            ))}
            ...
            <div className="flex flex-col space-y-4">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="text-gray-700 hover:text-cherry-red font-medium transition-colors px-2 py-2 cursor-pointer"
                  onClick={(e) => handleSmoothScroll(e, item.href)}
                >
                  {item.name}
                </a>
